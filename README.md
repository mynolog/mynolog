...
안녕하세요! TypeScript, React를 다루는 프론트엔드 개발자 **이민호**입니다. 

매장 운영과 고객 응대 경험을 바탕으로 사용자의 작은 불편도 놓치지 않기 위해 UI 흐름과 디테일을 함께 고민하는데 강점을 가지고 있습니다. 이 강점을 바탕으로 꾸준히 성장하는 개발자가 되기 위해 노력하고 있습니다.
